...
type Config struct {
	...
	// EmailClientID 是使用morse服务的clientID
...
// WithEmailClientID 设置EmailClientID字段
func (c *Config) WithEmailClientID(id string) *Config {
	c.EmailClientID = &id
	return c
}

// WithSSOHost 设置单点登陆服务host
func (c *Config) WithSSOHost(h string) *Config {
	c.SSOHost = &h
	return c
}

// WithGaeaHost 设置GaeaHost字段
func (c *Config) WithGaeaHost(h string) *Config {
	c.GaeaHost = &h
	return c
}
...
// WithMorseHost 设置邮件服务主机host
func (c *Config) WithMorseHost(h string) *Config {
	c.MorseHost = &h
	return c
}

// WithTradeHost 设置TradeHost
func (c *Config) WithTradeHost(h string) *Config {
	c.TradeHost = &h
	return c
}
...
// WithAccHost 设置AccHost
func (c *Config) WithAccHost(h string) *Config {
	c.AccHost = &h
	return c
}

// WithUser 设置User字段
func (c *Config) WithUser(u string) *Config {
	c.User = &u
	return c
}

// WithPass 设置Pass字段
func (c *Config) WithPass(p string) *Config {
	c.Pass = &p
	return c
}
...
func mergeInConfig(dst *Config, other *Config) {
	...
	if other.SSOHost != nil {
		dst.SSOHost = other.SSOHost
	}
	if other.MorseHost != nil {
		dst.MorseHost = other.MorseHost
	}
	if other.EmailClientID != nil {
		dst.EmailClientID = other.EmailClientID
	}
	if other.GaeaHost != nil {
		dst.GaeaHost = other.GaeaHost
	}
	if other.User != nil {
		dst.User = other.User
	}
	...
	if other.TradeHost != nil {
		dst.TradeHost = other.TradeHost
	}
	if other.AccHost != nil {
		dst.AccHost = other.AccHost
	}
