...
const (
	...
	// DefaultEmailClientID 发送邮件默认使用的clientID
	DefaultEmailClientID = "5ddccc8943f7bd0e0c0438b7"

	// DefaultMorseHost morse 邮件服务默认使用的host
	DefaultMorseHost = "https://morse.qiniu.io"
)
